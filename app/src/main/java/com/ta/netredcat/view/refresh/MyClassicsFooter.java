...
public class MyClassicsFooter extends InternalClassics<MyClassicsFooter> implements RefreshFooter {
    ...
    public MyClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View.inflate(context, com.scwang.smartrefresh.layout.R.layout.srl_classics_footer, this);
...
//            mTitleText.setTextSize(16);
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsFooter_srlTextNothing)) {
            ...
            mTextNothing = context.getString(com.scwang.smartrefresh.layout.R.string.srl_footer_nothing);
        }
...
//        mTitleText.setText(thisView.isInEditMode() ? AppConfigManager.getAppConfig().randomPullUpText() : mTextPulling);
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        if (!mNoMoreData) {
            switch (newState) {
                ...
                case LoadReleased:
                    arrowView.setVisibility(GONE);
//                    mTitleText.setText(AppConfigManager.getAppConfig().randomPullUpText());
                    break;
                case ReleaseToLoad:
